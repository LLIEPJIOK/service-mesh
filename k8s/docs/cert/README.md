...
> [!Important]
> Источник identity для выдачи сертификата - только валидированный токен [сервисного аккаунта](./../service/account/README.md#сервисный-аккаунт). CSR не должен определять identity сертификата.
